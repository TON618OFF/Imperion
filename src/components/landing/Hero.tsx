      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-primary/30 bg-primary/5 mb-8 animate-fade-in">
            ...
            <span className="text-sm text-primary font-medium">Новый способ изучать программирование</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 animate-fade-in" style={{ animationDelay: '0.2s' }}>
            Интерактивная платформа с практическими уроками, мгновенной проверкой кода 
            и системой достижений. Изучай Python, JavaScript, C++ и другие языки.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16 animate-fade-in" style={{ animationDelay: '0.3s' }}>
            ...
            <Button asChild variant="imperial-outline" size="xl" className="group">
              <Link to="/auth/login">
        ...
        <div className="hidden lg:block absolute left-10 top-1/3 animate-float" style={{ animationDelay: '0s' }}>
        ...
        <div className="hidden lg:block absolute right-10 top-1/2 animate-float" style={{ animationDelay: '2s' }}>
          <div className="bg-card/80 backdrop-blur-sm border border-border rounded-xl p-4 shadow-card">
